...
class NlpService {
  ...
  Transaction? _parseWithTflite(String smsContent) {
    // SMS parsing model placeholder
    return _parseWithRules(smsContent);
  }

  Transaction? _parseWithRules(String smsContent) {
    // Example: "Spent $24.50 at Starbucks on 2026-03-08"
  ...
  // Natural Language parsing (for Voice Entry)
  Transaction? parseSentence(String sentence) {
    ...
    // Extract merchant
    // Simple logic: Look for "at [Merchant]" or "from [Merchant]"
    ...
    if (merchantMatch != null) {
      ...
      // Fallback: Use the capitalized words as a guess for merchant if no keywords found
